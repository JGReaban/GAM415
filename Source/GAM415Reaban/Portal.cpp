...
APortal::APortal()
{
	...
	// Set root component and attach meshes to each other
...
void APortal::OnOverlapBegin(UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
	...
	AGAM415ReabanCharacter* playerChar = Cast<AGAM415ReabanCharacter>(OtherActor);
	...
	if (playerChar)
	{
		if (OtherPortal)
		{
			if (!playerChar->isTeleporting)
			{
				...
				// Reset Teleport flag after delay
...
void APortal::SetBool(AGAM415ReabanCharacter* playerChar)
{
	if (playerChar)
	{
